...
The biggest benefit that occurred as a result of the refactoring was an decrease in programming run time. As mentioned in the Analysis, the run time is more than 10 times faster after code refactoring.
